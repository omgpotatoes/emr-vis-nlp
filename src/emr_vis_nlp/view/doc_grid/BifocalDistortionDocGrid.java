...
/**
 * modified version of BifocalDistortion for use with document grid.
 *
 * @author alexander.p.conrad@gmail.com
 */
public class BifocalDistortionDocGrid extends Distortion {
    
    
    private double rx, ry; // magnification ranges
    private double mx, my; // magnification factor
    private Rectangle2D m_bbox;  // true bounding box for view
    
    /**
     * Create a new BifocalDistortion with default range and magnification.
     */
    public BifocalDistortionDocGrid(Rectangle2D bbox) {
        this(0.1,3,bbox);
    }
     ...
     */
    public BifocalDistortionDocGrid(double range, double mag, Rectangle2D bbox) {
        this(range,mag,range,mag,bbox);
    } //
     ...
     *  in the focal area
     */
    public BifocalDistortionDocGrid(double xrange, double xmag, 
                             double yrange, double ymag, Rectangle2D bbox)
    {
        rx = xrange;
        mx = xmag;
        ry = yrange;
            ...
            Point2D anchor, Rectangle2D bounds)
    {
        ...
        bounds = m_bbox;
        bbox = new Rectangle((int)x, (int)y, 25, 25);  // TODO get proper size info into method!
