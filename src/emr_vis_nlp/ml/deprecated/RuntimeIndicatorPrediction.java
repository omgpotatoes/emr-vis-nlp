...
public class RuntimeIndicatorPrediction {
    ...
    private static HashMap<String, Boolean> predictionNamesMap;
...
//            }
    ...
    public static Map<String, Double> getTermWeightsForIndicator(String indicatorName) {
        ...
        String indicatorNameOld = DatasetTermTranslator.getRevAttrTranslation(indicatorName);
        for (int i=0; i<predictedIndicatorNames.length; i++) {
            if (indicatorNameOld.equals(predictedIndicatorNames[i])) {
                predNameFound = true;
